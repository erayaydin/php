<div class="container">
    <div class="row">
        ...
        <div class="col-md-10">
            <p class="text-right">
                <a href="index.php?panel=admin&module=book&action=create" class="btn btn-success">Yeni Kitap Ekle <i class="fa fa-plus-circle"></i></a>
            </p>
            <form method="post">
                                ...
                                <?php foreach($search as $book): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <?php else: ?>
                                                <span class="label label-success">Mevcut (<?php echo $book->quantity-$borrows; ?>)</span>
                                            <?php endif; ?>
                                        </td>
                                        <td class="text-right">
                                            <a href="index.php?panel=admin&module=action&action=give&book=<?php echo $book->id; ?>" class="btn btn-xs btn-primary">Ödünç Ver <i class="fa fa-book"></i></a>
                                            <a href="index.php?panel=admin&module=book&action=edit&book=<?php echo $book->id; ?>" class="btn btn-xs btn-warning">Düzenle <i class="fa fa-pencil"></i></a>
                                            <a href="index.php?panel=admin&module=book&action=delete&book=<?php echo $book->id; ?>" class="btn btn-xs btn-danger">Sil <i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                                </tbody>
